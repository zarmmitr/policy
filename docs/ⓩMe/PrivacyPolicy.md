...
*   **Application** means the software program provided by the Company downloaded by You on any electronic device, named ⓩ Me
    
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Zarmmitr.
...
*   **Website** refers to Privacy Policy, accessible from [https://github.com/organizations/zarmmitr](https://github.com/organizations/zarmmitr)
